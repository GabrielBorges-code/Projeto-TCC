...
<main>
    <div class="conteudo">
        ...
        <span class="span-padrao">R$</span><input class="input-padrao" type="number" name="valorInvestir" id="valorInvestir" required> 

        <label for="prazo">Prazo do Investimento</label>
        <input class="input-padrao" type="number" name="prazo" id="prazo" required><span id="span-meses" class="span-padrao">Meses</span>

        <label for="rentabilidade">Rentabilidade ao Ano</label>
        <input class="input-padrao" type="number" name="rentabilidade" id="rentabilidade" required><span id="span-ao-ano" class="span-padrao">% ao ano</span>
